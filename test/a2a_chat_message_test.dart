...
import 'package:a2a/src/client/src/a2a_genai_primitives_mapper.dart'; 
...
void main() {
  group('ChatMessage to A2AMessage Mapping', () {
    ...
    test('Maps message with taskId and contextId', () {
      ...
      final a2aMessage = chatMessage.toA2AMessage(taskId: 'task1', contextId: 'ctx1');
    ...
    test('Maps DataPart to A2AFilePart with bytes', () {
        ...
        final dataPart = DataPart(bytes, mimeType: 'text/plain', name: 'test.txt');
        final chatMessage = ChatMessage(role: ChatMessageRole.user, parts: [dataPart]);
    ...
    test('Maps LinkPart to A2AFilePart with URI', () {
        ...
        final chatMessage = ChatMessage(role: ChatMessageRole.user, parts: [linkPart]);
